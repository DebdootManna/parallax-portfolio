  ...
  const projects = [
    {
      ...
      category: "Research",
      description: "Investigating vulnerabilities in deep learning systems and developing countermeasures against adversarial attacks.",
      icon: <Brain className="w-6 h-6" />,
      tags: ["AI Security", "Deep Learning", "Adversarial ML"],
      color: "primary",
    },
    {
      title: "The Messengers: Galactic Patterns",
      category: "Music",
      description: "Electronic music project exploring mathematical patterns through sound design and algorithmic composition.",
