  ...
  const handleNavClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
    ...
    if (href && href.startsWith('#')) {
      ...
      if (element) {
        ...
        // Smooth scroll with a slight delay to ensure menu closing animation completes
        setTimeout(() => {
              ...
              {isSocialOpen && (
                ...
                >
                  <div className="flex flex-col space-y-3">
                    ...
                    <a 
                      href="https://twitter.com/DebdootManna" 
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="social-menu-link flex items-center space-x-2 p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                      onClick={() => setIsSocialOpen(false)}
                    ...
                    <a 
                      href="https://soundcloud.com/themessengersmusic" 
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="social-menu-link flex items-center space-x-2 p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                      onClick={() => setIsSocialOpen(false)}
                    ...
                    <a 
                      href="https://instagram.com/themessengersmusic" 
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="social-menu-link flex items-center space-x-2 p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                      onClick={() => setIsSocialOpen(false)}
            ...
            <div className="container mx-auto px-4 py-4">
              <nav className="flex flex-col space-y-3">
                ...
                <div className="flex items-center space-x-3 pt-2">
                  ...
                  <a href="https://instagram.com/themessengersmusic" target="_blank" rel="noopener noreferrer" className="social-icon">
                    <Instagram className="w-5 h-5" />
                  </a>
                  <ThemeSwitcher />
                </div>
